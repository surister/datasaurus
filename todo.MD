...
- [ ] Add more options to Columns depending on the column Type, like 'unique',  ~~'column_name'~~... etc
- [ ] If auto_id is added, see how to add another option, ex: 'default' so we can pass stuff like lambda x: uuid4
